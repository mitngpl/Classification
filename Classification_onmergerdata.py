        ...
        dataSet = pd.read_csv(fileName,
                              usecols=[ 'ID', 'Colour _Name_', 'Colour colour 1', 'Colour colour 2',
                                       ...
                                       'Reflectance roughness','Reflectance specular factor',
                                        ...
                                        'Type_8 t origin','Type_8 t reflect','Type_8 t scale','Group'])
    else:
        # get Test data
        dataSet = pd.read_csv(fileName,
                              usecols=[ 'ID', 'Colour _Name_', 'Colour colour 1', 'Colour colour 2',
                                       ...
                                       'Reflectance roughness','Reflectance specular factor',
                                        ...
                                        'Type_8 t offset',
                                        'Type_8 t origin', 'Type_8 t reflect', 'Type_8 t scale'])
...
argumanet1 = "./combined_training.csv"
X, y = getDataSet(argumanet1,1)
